...
public class test_ini extends AppCompatActivity {
    ...
    String [] suraktar = {"Іні армияға бардыма?", "Іні жасы қаншада?", "Іні не жақсы көреді?", "Іні күштіма?", "Іні машина айдайма?", "Іні қанша немересі бар?", "Іні ұнататаын тамағы?", "Іні ақылды ма?","Іні жақсы көресінба?", "Іні сені жақсы көрема?"};

    double bari = suraktar.length;
    double count = 0;
    String [] answer = {"жок", "9", "ойын", "әрине","жок", "4", "манты", "иа","Әрине", "солай шығар"};
    String [][] variant = {
            {"иа", "жок","мумкин","нет"},
            {"72", "9", "54", "95"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_ini);
