...
public class test_karindas extends AppCompatActivity {
    ...
    String [] suraktar = {"Қарындас армияға бардыма?", "Қарындас жасы қаншада?", "Қарындас не жақсы көреді?", "Қарындас күштіма?", "Қарындас машина айдайма?", "Қарындас қанша немересі бар?", "Қарындас ұнататаын тамағы?", "Қарындас ақылды ма?","Қарындас жақсы көресінба?", "Қарындас сені жақсы көрема?"};

    double bari = suraktar.length;
    double count = 0;
    String [] answer = {"жок", "15", "китап", "әрине","жок", "4", "манты", "иа","Әрине", "солай шығар"};
    String [][] variant = {
            {"иа", "жок","мумкин","нет"},
            {"72", "15", "54", "95"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_karindas);
