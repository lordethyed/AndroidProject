...
public class test_apa extends AppCompatActivity {
    ...
    String [] suraktar = {"Апа армияға бардыма?", "Апанын жасы қаншада?", "Апа не жақсы көреді?", "Апа күштіма?", "Апа машина айдайма?", "Апа қанша немересі бар?", "Апа ұнататаын тамағы?", "Апа ақылды ма?","Апаны жақсы көресінба?", "Апа сені жақсы көрема?"};

    double bari = suraktar.length;
    double count = 0;
    String [] answer = {"жок", "61", "китап", "әрине","жок", "4", "манты", "иа","Әрине", "солай шығар"};
    String [][] variant = {
            {"иа", "жок","мумкин","нет"},
            {"72", "61", "54", "95"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.test_apa);
